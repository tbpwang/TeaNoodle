...
public class PicView extends ApplicationTemplate
{
    ...
    public static class VAppFrame extends AppFrame
    {
        public VAppFrame()
        {
            ...
            getWwd().getView().setEyePosition(new Position(viewCenter, Term.getSphere().getRadius()));
...
//        surfacePolygon.getLocations(Term.getSphere())
//        LatLon.getCenter(surfacePolygon.getLocations(Term.getSphere()));
...
//        double area = trigon1.getArea(Term.getSphere())+trigon2.getArea(Term.getSphere());
//        IO.write("simulateEntityArea",trigon1.getArea(Term.getSphere()));
//        IO.write("simulateEntityArea",trigon2.getArea(Term.getSphere()));
...
//        polyline.setVisible(true);
    ...
    public static AppFrame start(String title, Class appFrameClass)
    {
...
//        vertex1 = new Vertex(Term.fromVec4(Octant.getInstance().getFacet(0).getVertex()[0]),"0");
//        vertex2 = new Vertex(Term.fromVec4(Octant.getInstance().getFacet(0).getVertex()[1]),"1");
//        vertex3 = new Vertex(Term.fromVec4(Octant.getInstance().getFacet(0).getVertex()[2]),"2");
...
//        init(new Graph(triangle2,level));
        ...
        start("SimulateGeographicEntity", VAppFrame.class);
    }
}
