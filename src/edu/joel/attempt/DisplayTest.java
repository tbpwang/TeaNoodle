...
import edu.joel.*;
import edu.joel.impl.IcosahedronInscribed;
...
//            List<Position> positions = new ArrayList<>();
            ...
            for (Triangle t : facets)
            {
                ...
                positions.add(new Position(Constant.vec4ToLatLon(t.getA()), 0.0));
                positions.add(new Position(Constant.vec4ToLatLon(t.getB()), 0.0));
                positions.add(new Position(Constant.vec4ToLatLon(t.getC()), 0.0));
                positions.add(new Position(Constant.vec4ToLatLon(t.getA()), 0.0));
...
//                Vec4.computeAveragePoint(vertexes);
                centerOfMass.add(Constant.vec4ToLatLon(Vec4.computeAveragePoint(vertexes)));
