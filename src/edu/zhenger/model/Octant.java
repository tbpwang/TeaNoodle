...
public class Octant implements Polyhedron
{
    ...
    {
        cells = new Cell[8];
        cells[0] = new Trigon(LatLon.fromDegrees(90, -180), LatLon.fromDegrees(0, -180), LatLon.fromDegrees(0, -90),
            "0");
        ...
        cells[4] = new Trigon(LatLon.fromDegrees(-90, -180), LatLon.fromDegrees(0, -180), LatLon.fromDegrees(0, -90),
            "4");
