...
public class OctantMeshMidArcs implements Partition
{
    ...
    public OctantMeshMidArcs(int facet, int level)
    {
        this.level = level;
        this.trigon = (Trigon) Octant.getInstance().getFacet(facet);
    ...
    public Trigon[] subdivide(Trigon trigon)
    {
        ...
        LatLon top, left, right, t, l, r, lTop, rTop;
        top = trigon.getTop();
        left = trigon.getLeft();
        ...
        r = LatLon.interpolateGreatCircle(0.5f, lTop, left);
        l = LatLon.interpolateGreatCircle(0.5f, right, rTop);
