...
//            List<Position> positions = new ArrayList<>();
            ...
            for (Triangle t : facets)
            {
                ...
                positions.add(new Position(Cons.vec4ToLatLon(t.getA()), 0.0));
                positions.add(new Position(Cons.vec4ToLatLon(t.getB()), 0.0));
                positions.add(new Position(Cons.vec4ToLatLon(t.getC()), 0.0));
                positions.add(new Position(Cons.vec4ToLatLon(t.getA()), 0.0));
...
//                Vec4.computeAveragePoint(vertexes);
                centerOfMass.add(Cons.vec4ToLatLon(Vec4.computeAveragePoint(vertexes)));
...
//            attr.setOutlineStipplePattern();
        ...
        private Mesh fill(MiddleArcSurfaceTriangle initCell, int level)
        {
            ...
            list.add(initCell);
            EssentialVariable.refineTriangle(level, list);
