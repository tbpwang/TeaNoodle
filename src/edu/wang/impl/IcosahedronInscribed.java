...
//    }
    ...
    private IcosahedronInscribed(String source)
    {
        ...
        facets = new Triangle[20];
        facets[0] = new Triangle(Cons.latLonToVec4(vertices[0]), Cons.latLonToVec4(vertices[1]),
            Cons.latLonToVec4(vertices[2]));
        facets[1] = new Triangle(Cons.latLonToVec4(vertices[0]), Cons.latLonToVec4(vertices[2]),
            Cons.latLonToVec4(vertices[3]));
        facets[2] = new Triangle(Cons.latLonToVec4(vertices[0]), Cons.latLonToVec4(vertices[3]),
            Cons.latLonToVec4(vertices[4]));
        facets[3] = new Triangle(Cons.latLonToVec4(vertices[0]), Cons.latLonToVec4(vertices[4]),
            Cons.latLonToVec4(vertices[5]));
        facets[4] = new Triangle(Cons.latLonToVec4(vertices[0]), Cons.latLonToVec4(vertices[5]),
            Cons.latLonToVec4(vertices[1]));
        facets[5] = new Triangle(Cons.latLonToVec4(vertices[6]), Cons.latLonToVec4(vertices[1]),
            Cons.latLonToVec4(vertices[2]));
        facets[6] = new Triangle(Cons.latLonToVec4(vertices[7]), Cons.latLonToVec4(vertices[2]),
            Cons.latLonToVec4(vertices[3]));
        facets[7] = new Triangle(Cons.latLonToVec4(vertices[8]), Cons.latLonToVec4(vertices[3]),
            Cons.latLonToVec4(vertices[4]));
        facets[8] = new Triangle(Cons.latLonToVec4(vertices[9]), Cons.latLonToVec4(vertices[4]),
            Cons.latLonToVec4(vertices[5]));
        facets[9] = new Triangle(Cons.latLonToVec4(vertices[10]), Cons.latLonToVec4(vertices[5]),
            Cons.latLonToVec4(vertices[1]));
        facets[10] = new Triangle(Cons.latLonToVec4(vertices[2]), Cons.latLonToVec4(vertices[6]),
            Cons.latLonToVec4(vertices[7]));
        facets[11] = new Triangle(Cons.latLonToVec4(vertices[3]), Cons.latLonToVec4(vertices[7]),
            Cons.latLonToVec4(vertices[8]));
        facets[12] = new Triangle(Cons.latLonToVec4(vertices[4]), Cons.latLonToVec4(vertices[8]),
            Cons.latLonToVec4(vertices[9]));
        facets[13] = new Triangle(Cons.latLonToVec4(vertices[5]), Cons.latLonToVec4(vertices[9]),
            Cons.latLonToVec4(vertices[10]));
        facets[14] = new Triangle(Cons.latLonToVec4(vertices[1]), Cons.latLonToVec4(vertices[10]),
            Cons.latLonToVec4(vertices[6]));
        facets[15] = new Triangle(Cons.latLonToVec4(vertices[11]), Cons.latLonToVec4(vertices[6]),
            Cons.latLonToVec4(vertices[7]));
        facets[16] = new Triangle(Cons.latLonToVec4(vertices[11]), Cons.latLonToVec4(vertices[7]),
            Cons.latLonToVec4(vertices[8]));
        facets[17] = new Triangle(Cons.latLonToVec4(vertices[11]), Cons.latLonToVec4(vertices[8]),
            Cons.latLonToVec4(vertices[9]));
        facets[18] = new Triangle(Cons.latLonToVec4(vertices[11]), Cons.latLonToVec4(vertices[9]),
            Cons.latLonToVec4(vertices[10]));
        facets[19] = new Triangle(Cons.latLonToVec4(vertices[11]), Cons.latLonToVec4(vertices[10]),
            Cons.latLonToVec4(vertices[6]));
    }
