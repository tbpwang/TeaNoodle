...
public class SphereStatisticsPoint
{
    ...
    private void setResultant()
    {
        ...
        this.resultant = Cons.check(x, y, z);
    }
    ...
    {
        double length = getResultant().getLength3() <= Cons.epsilon ? 1.0 : getResultant().getLength3();
        Vec4 v = getResultant().divide3(length);
        this.sphericalMean = Cons.check(v);
    }
...
//    }
    ...
    {
        setDispersion();
        return Cons.getGlobe().getRadius() * this.dispersion;
    }
    ...
    private void setMatrixT()
    {
        ...
        r11 = Cons.check(r11 / size);
        r12 = Cons.check(r12 / size);
        r13 = Cons.check(r13 / size);
        r22 = Cons.check(r22 / size);
        r23 = Cons.check(r23 / size);
        r33 = Cons.check(r33 / size);
