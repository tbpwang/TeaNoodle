...
public class SphereStatisticsPoint
{
    ...
    private void setResultant()
    {
        ...
        this.resultant = Constant.check(x, y, z);
    }
    ...
    {
        double length = getResultant().getLength3() <= Constant.epsilon ? 1.0 : getResultant().getLength3();
        Vec4 v = getResultant().divide3(length);
        this.sphericalMean = Constant.check(v);
    }
    ...
    private void setMassCenter()
    {
        ...
        this.massCenter = Constant.check(v);
    }
...
//    }
    ...
    {
        setDispersion();
        return Constant.getGlobe().getRadius() * this.dispersion;
    }
    ...
    private void setMatrixT()
    {
        ...
        r11 = Constant.check(r11 / size);
        r12 = Constant.check(r12 / size);
        r13 = Constant.check(r13 / size);
        r22 = Constant.check(r22 / size);
        r23 = Constant.check(r23 / size);
        r33 = Constant.check(r33 / size);
