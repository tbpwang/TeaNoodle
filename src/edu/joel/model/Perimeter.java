...
public class Perimeter
{
    public static double getPlanePerimeter(Vec4 a, Vec4 b, Vec4 c)
    {
        ...
        return (p1.distanceTo3(p2) + p1.distanceTo3(p3) + p2.distanceTo3(p3)) * Constant.radius;
    }
    ...
    public static double getSpherePerimeter(LatLon a, LatLon b, LatLon c)
    {
        ...
        return Constant.radius * (LatLon.greatCircleDistance(a, b).radians + LatLon.greatCircleDistance(a, c).radians
